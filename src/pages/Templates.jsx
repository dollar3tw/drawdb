...
import { getAllTemplatesAPI, deleteTemplateAPI } from "../data/db";
...
export default function Templates() {
  ...
  const loadTemplates = async () => {
    try {
      ...
      setDefaultTemplates(templates.filter(t => t.custom === 0));
      setCustomTemplates(templates.filter(t => t.custom === 1));
    } catch (error) {
